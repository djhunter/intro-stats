...
| Date | Topics |
|:---- |:-------------------------- |
| 1/10 | [Hello Data](slides/01-hellodata.html) <br> [Association and Experiments](slides/01b-association.html) |

---
# | 1/12 | [Study Design](slides/02-studydesign.html) <br> [Getting Started with Data in R](slides/03-intro_data_R.html) |
# 1/19 [Exploring Categorical Data](slides/04-catdata.html)
#  [Exploring Numerical Data](slides/05-numdata.html)
# 1/24 [Exploratory Data Analysis in R](slides/06-explore_data_R.html)
# [Linear Regression with a Single Predictor](slides/07a-lin_regression.html)
# 1/26 [Linear Regression with Multiple Predictors](slides/08-multi_regression.html)
#  [Logistic Regression](slides/09-logit_regression.html)
# 1/31 [Regression Models in R](slides/10-regression_R.html)
...
- [How to install R and RStudio](assignments/)
