...
| 10/20 | [Inference on Categorical Variables in R](slides/18-infer_chisquare.html) |
...
# | 10/30 | [Bootstrapping and t-tests in R](slides/19b-onemean_R.html) |
# | 11/1 | [Inference for Comparing Two Independent Means](slides/20-infer_twomean.html) |
# | 11/3 | [Inference for Comparing Paired Means](slides/21-infer_pairedmean.html) |
# | 11/6 | [Inference for Comparing Many Means](slides/22-infer_manymeans.html) |
# | 11/8 | [Inference for Numerical Data in R](slides/23b-num_infer_R.html) |
# | 11/10 | [Inference for Linear Regression](slides/24-infer_regression.html) |
# | 11/13 | [Inference for Linear Regression, continued](slides/24-infer_regression.html)  |
# | 11/15 | [Review for Test #3](slides/24c-test3review.html) |
# | 11/17 | Test #3, Chapters 19-24??
# Note: modify spreadsheet if dates change for tests
# | 11/20 |  [Inference for Multiple Regression](slides/25-infer_multiple.html) |
# | 11/27 | [Inference for Multiple Regression in R](slides/27-mariokart.html) 
# | 11/29 | [Inference for Logistic Regression](slides/26-infer_logistic.html) |
# | 12/1 | [Inference for Logistic Regression in R](slides/27b-nbarookies.html) |
# Two extra days
