...
---
# | 2/22 | [Inference for a Single Proportion](slides/16-infer_1prop.html) <br> [Inference for Comparing Two Proportions](slides/17-infer_2prop.html) |
# | 2/27 | [Inference for Comparing Two Proportions (continued)](slides/17-infer_2prop.html) <br> [Inference for Two-Way Tables](slides/18-infer_chisquare.html) |
# | 2/29 | [Inference on Categorical Variables in R](slides/18a-infer_cat_R.html) <br> [Review for Test #2](slides/18c-test2review.html) |
# | 3/5 | Test #2, Chapters 9-18 |
# | 3/7 |  [Inference for a Single Mean](slides/19-infer_onemean.html) <br> [Bootstrapping and t-tests in R](slides/19b-onemean_R.html) |
