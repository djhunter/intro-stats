...
5. Analyze these data to **address the question of whether American men and women differ with regard to donating blood.** Write down hypotheses, a p-value, and a confidence interval using theory-based methods, if valid. If you decide that men and women differ significantly, be sure to *estimate by how much* they differ. [Use this form to give a summary of your findings](https://goo.gl/forms/YqvQImKqJ3P0mm4n1) in paragraph form.
