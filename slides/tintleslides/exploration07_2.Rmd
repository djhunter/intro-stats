...
<div class="column-right">
```{r, echo=FALSE}
firstbase <- read.table("FirstBase.txt", header = TRUE)
firstbase
```
</div>
...
- We will then repeat this process many times to develop a null distribution. (See PPT animation.)
...
<div class="column-right">
```{r, echo=FALSE}
jjbike <- read.table("JJvsBicycle.txt", header=TRUE)
