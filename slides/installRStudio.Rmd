...
Choose the appropriate installer for your operating system. The latest release of R is 4.3.1 (Innocent and Trusting). 

- Mac users: pay attention to the MacOS prerequisites, and choose the appropriate version for your system (Apple silicon (M1/M2) arm64 or Intel). R version 4.3.1 requires MacOS 11 or greater. If you have an older version of MacOS, you can try installing one of the older versions of R.
