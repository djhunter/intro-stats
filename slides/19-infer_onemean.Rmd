...
4. Select *Beyond* from the count samples dropdown. Use trial and error to find the upper endpoint of a 95% percentile confidence interval. (You want the total area in both tails to be 0.05.)
