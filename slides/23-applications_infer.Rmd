...
| ----- | ----- | ----- |
| Categorical | none        | One-proportion z-test |
| Categorical (2 levels) | Categorical (2 levels) | Two-proportion z-test |
| Categorical ($\geq$ 2 levels) | Categorical ($\geq$ 2 levels) | Chi-squared |
|  Numerical | none  | One-sample t-test |
| Numerical | Categorical (2 levels) | Two-sample t-test |
| Numerical | Categorical (2 levels, paired) | Paired t-test |
| Numerical | Categorical ($\geq$ 2 levels) | ANOVA F-test |
...
ggplot(redundant, aes(x = items, y = redundant_perc, fill = Language)) + geom_boxplot()
``` 
