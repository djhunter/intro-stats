...
- Constant variance (the SD of each group should b approximately equal.)
...
3. Check the box to *Overlay F distribution*. **Record** a theory-based p-value for the above test using the ANOVA $F$-test. Compare the three p-values you found: simulation-based using MAD, simulation-based using $F$, and theory-based using the ANOVA $F$-test.
