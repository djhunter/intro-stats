...
1. Consider the 41 home games as the observational units. What two variables are recorded on these observational units? Which is explanatory, and which is response?

2. Is this an experiment or an observational study?

3. Is the presence of a sell-out crowd causing the team to lose more often? Come up with a plausible *confounding variable* that explains the association.
