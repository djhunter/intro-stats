...
## Challenges. 
# 1. Look at the diagnostic plots. Do you notice any
# patterns in the residuals? Use plot(bfit1, 1)
# 2. Redo the above scatterplot, but color the points according
# to the different species. What do you notice?
...
## Challenges.
# 1. Make separate data frames for the other two species.
# 2. Make a separate regression model for each species. 
#    Record the regression slopes for each model. 
#    Are they significant?
# 3. Investigate the residual vs. fit plots for each model.

## Confidence intervals
bfit2 <- lm(bill_depth_mm ~ bill_length_mm, data = penGentoo)
summary(bfit2)
0.20484 + c(-1,1) * 2 * 0.022
confint(bfit2)
```
