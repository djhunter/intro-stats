...
\usepackage{fancyhdr}
\pagestyle{fancy}
\lhead{MA-005, Hunter, Spring 2024}
...
will receive a zero. Late homework is worth 75\% for the first 48 hours
beyond the due date, and then 0\% thereafter. In the event of an
\textbf{excused absence}, you can make up the participation grade by
writing up answers to all the group activity questions found in the
slides for the day that you missed. Hand in this written work when you
return to class, and make sure it includes the reason for your absence.
